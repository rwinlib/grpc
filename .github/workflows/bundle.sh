...
mkdir -p lib share lib-8.3.0/{x64,i386} bin{32,}
...
cp -rv ${OUTPUT}/ucrt64/share/grpc share/
cp -v ${OUTPUT}/ucrt64/bin/{protoc,grpc_cpp_plugin}.exe bin/
cp -v ${OUTPUT}/mingw32/bin/{protoc,grpc_cpp_plugin}.exe bin32/
